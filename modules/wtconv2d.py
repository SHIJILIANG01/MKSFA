...
class WT_downsample(nn.Module):
    def __init__(self, in_c, out_c, kernel_size=3, stride=1, wt_levels=3):
        super(WT_downsample, self).__init__()
        self.conv = nn.Sequential(
            nn.Conv2d(in_c, out_c, 1),
            WTConv2d(out_c, out_c, kernel_size, stride, wt_levels),
        )
...
class WT_upsample(nn.Module):
    def __init__(self, in_c, out_c, kernel_size=3, stride=1, wt_levels=3):
        super(WT_upsample, self).__init__()
        self.conv = nn.Sequential(
